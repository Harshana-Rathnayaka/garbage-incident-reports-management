...
?>
    ...
    <script type="text/javascript"
            src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyDbEHaIJdMmORdjhrlO7bBeaoJx1hPt3BU">
    </script>
    ...
    <script>
        ...
        var addMarker = google.maps.event.addListener(map, 'click', function(e) {
            ...
            var marker = new google.maps.Marker({
                ...
                "            <tr>\n" +
                "                <td><a>Remark:</a></td>\n" +
                "                <td><textarea  id='manual_description' placeholder='Remark'></textarea></td></tr>\n" +
